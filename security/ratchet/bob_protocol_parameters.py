class BobProtocolParameters:
    ...
    @staticmethod
    def newBuilder():
        return BobProtocolParameters.Builder()
    ...
    class Builder:
        ...
        def create(self):
            return BobProtocolParameters(self.ourIdentityKey, self.ourSignedPreKey, self.ourRatchetKey,
